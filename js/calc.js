function calc(dt) {
    ...
    if (player.uniTime.gte(STORY.progress[player.story+1]||E(1/0)) && player.story < 99) player.story++
    ...
    if (hasUpg("ft",8)) player.susy.particles = player.susy.particles.add(tmp.susy.resetGain.mul('e1000'))
}